...
.controller('AccountCtrl', [$scope, $rootScope, $ionicUser, $ionicPush, $cordovaToast,  $ionicDeploy, piItems, $firebaseObject, function ($scope, $rootScope, $ionicUser, $ionicPush, $cordovaToast,  $ionicDeploy, piItems, $firebaseObject)  {
		$scope.settings = {
			enableFriends: true
		};
